...
<section class="iniciar-sesion">
        ...
        <h2 class="iniciar-sesion-h2">
          ...
          <form class="box" action ="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
              ...
              <input type="password" name="confirm_password" placeholder ="Contrasena" class="form-control <?php echo (!empty($confirm_password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $confirm_password; ?>">
              <span class="invalid-feedback"><?php echo $confirm_password_err; ?></span>
              <label for="">Confirmar Contrasena</label>
              <small>
              <p>Ya tienes una cuenta? <a href="login.php">Login acá </a>.</p>
